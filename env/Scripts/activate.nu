...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\jeanm\OneDrive\Documentos\Jean\Preparación finaniera\Preparacion financiera\Cursos Python\Introducciondjango\env'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\jeanm\OneDrive\Documentos\Jean\Preparación finaniera\Preparacion financiera\Cursos Python\Introducciondjango\env\Scripts\deactivate.nu'
